...
public class OrderDAO extends JpaDAO<BookOrder> implements GenericDAO<BookOrder> {
	...
	public List<BookOrder> findAllPagedOrder(int page) {
	    ...
	    return super.findAllWithPagination("BookOrder.findAll", firstResult, 10);
	}
	
	public List<BookOrder> listByCustomerPagedOrder(Integer customerId, int page) {
	    int firstResult = (page - 1) * 10;
	    return super.findwithNameQueryWithPagination("BookOrder.findByCustomer", "customerId", customerId, firstResult, 10);
	}
